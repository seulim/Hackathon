	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 169,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: 'images/progressbg_green.gif'
				height			: 12,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				//boxImage		: '../../../images/320/event/event72/bar_2.png',// boxImage : image around the progress bar
				barImage		: {
									0:	'../../../event/attend/201205/progressbarImg/bar_1.png',
									30: '../../../event/attend/201205/progressbarImg/bar_1.png',
									70: '../../../event/attend/201205/progressbarImg/bar_1.png'
								},
